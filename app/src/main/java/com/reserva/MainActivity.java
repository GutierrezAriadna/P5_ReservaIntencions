...
public class MainActivity extends Activity implements OnSeekBarChangeListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			regreso = this.getIntent().getExtras();
			if (regreso.getString("ServicioExtra") != null)
				Toast.makeText(getApplicationContext(), "Reservado. Servicio Extra: " + regreso.getString("ServicioExtra"), Toast.LENGTH_SHORT).show();
